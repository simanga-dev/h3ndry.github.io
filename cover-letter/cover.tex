...
\documentclass[12pt,a4paper,roman]{cover}
\usepackage{fancyhdr}
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Simanga Hendry}{Khoza}{ \urlstyle{same}\href{https://hendry.xyz}{www.hendry.xyz} | \href{mailto:h3khoza@gmail.com}{h3khoza@gmail.com} | +27
812490306 | \urlstyle{same}\href{https://github.com/h3ndry}{Github} | \urlstyle{same}\href{https://linkedin.com}{Linkedin}
}
...
\closing{Sincerely,\\ \vspace{.1cm} \includegraphics[width=4cm]{OpenFonts/signature_1} \vspace{-1cm} }

\signature{Simanga Hendry Khoza}
